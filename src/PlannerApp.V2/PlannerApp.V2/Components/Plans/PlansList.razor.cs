...
{
    /// <summary>
    /// This class is the parent class for the PlanCardsList in here we will find all the logic we need for the plans.
    /// We separete all this classes to have a better view over the code and to not repet ourself.
    /// </summary>
